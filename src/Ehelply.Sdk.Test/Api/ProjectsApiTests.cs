...
namespace Ehelply.Sdk.Test.Api
{
    ...
    public class ProjectsApiTests : IDisposable
    {
        ...
        public void SearchProjectsTest()
        {
            ...
            //string ehelplyProject = null;
            //string ehelplyData = null;
            //var response = instance.SearchProjects(page, pageSize, search, searchOn, sortOn, sortDesc, xAccessToken, xSecretToken, authorization, ehelplyActiveParticipant, ehelplyProject, ehelplyData);
