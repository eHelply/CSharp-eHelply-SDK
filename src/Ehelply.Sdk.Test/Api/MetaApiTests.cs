...
namespace Ehelply.Sdk.Test.Api
{
    ...
    public class MetaApiTests : IDisposable
    {
        ...
        public void DeleteMetaTest()
        {
            ...
            //string ehelplyProject = null;
            //string ehelplyData = null;
            //var response = instance.DeleteMeta(service, type, entityUuid, xAccessToken, xSecretToken, authorization, ehelplyActiveParticipant, ehelplyProject, ehelplyData);
            //Assert.IsType<Object>(response);
        }
        ...
        public void GetMetaTest()
        {
            ...
            //string ehelplyProject = null;
            //string ehelplyData = null;
            //var response = instance.GetMeta(service, type, entityUuid, detailed, custom, dates, history, xAccessToken, xSecretToken, authorization, ehelplyActiveParticipant, ehelplyProject, ehelplyData);
            //Assert.IsType<MetaDynamo>(response);
        }
        ...
        public void TouchMetaTest()
        {
            ...
            //string ehelplyProject = null;
            //string ehelplyData = null;
            //var response = instance.TouchMeta(service, type, entityUuid, xAccessToken, xSecretToken, authorization, ehelplyActiveParticipant, ehelplyProject, ehelplyData);
            //Assert.IsType<MetaDynamo>(response);
        }
        ...
        public void UpdateMetaTest()
        {
            ...
            //string ehelplyProject = null;
            //string ehelplyData = null;
            //var response = instance.UpdateMeta(service, type, entityUuid, metaCreate, xAccessToken, xSecretToken, authorization, ehelplyActiveParticipant, ehelplyProject, ehelplyData);
            //Assert.IsType<MetaDynamo>(response);
        }
