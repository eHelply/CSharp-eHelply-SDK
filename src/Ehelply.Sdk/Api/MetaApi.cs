...
namespace Ehelply.Sdk.Api
{
    ...
    public partial class MetaApi : IMetaApi
    {
        ...
        {
            Ehelply.Sdk.Client.ApiResponse<MetaDynamo> localVarResponse = await GetMetaWithHttpInfoAsync(service, typeStr, entityUuid, detailed, custom, dates, history, xAccessToken, xSecretToken, authorization, ehelplyActiveParticipant, ehelplyProject, ehelplyData, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Ehelply.Sdk.Client.ApiResponse<MetaDynamo> localVarResponse = await GetMetaFromUuidWithHttpInfoAsync(metaUuid, detailed, custom, dates, history, xAccessToken, xSecretToken, authorization, ehelplyActiveParticipant, ehelplyProject, ehelplyData, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
