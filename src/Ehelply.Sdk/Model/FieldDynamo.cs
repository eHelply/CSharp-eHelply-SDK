...
namespace Ehelply.Sdk.Model
{
    ...
    public partial class FieldDynamo : IEquatable<FieldDynamo>, IValidatableObject
    {
        ...
        public FieldDynamo(int type = default(int), string placeholder = default(string), Validations validations = default(Validations), string hint = default(string), string icon = default(string), string label = default(string), Options options = default(Options), string uuid = default(string))
        {
