...
namespace Ehelply.Sdk.Model
{
    ...
    public partial class FieldDynamo : IEquatable<FieldDynamo>, IValidatableObject
    {
        ...
        public FieldDynamo(Object type = default(Object), string placeholder = default(string), Object validations = default(Object), string hint = default(string), string icon = default(string), string label = default(string), Object options = default(Object), string uuid = default(string))
        {
