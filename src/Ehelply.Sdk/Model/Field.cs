...
namespace Ehelply.Sdk.Model
{
    ...
    public partial class Field : IEquatable<Field>, IValidatableObject
    {
        ...
        public Field(Object type = default(Object), string placeholder = default(string), Object validations = default(Object), string hint = default(string), string icon = default(string), string label = default(string), Object options = default(Object))
        {
            this.Type = type;
