...
namespace Ehelply.Sdk.Model
{
    ...
    public partial class Field : IEquatable<Field>, IValidatableObject
    {
        ...
        public Field(string uuid = default(string), int type = default(int), string placeholder = default(string), Object validations = default(Object), string hint = default(string), string icon = default(string), string label = default(string), Options options = default(Options))
        {
            this.Uuid = uuid;
            this.Type = type;
