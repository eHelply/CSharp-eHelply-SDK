...
namespace Ehelply.Sdk.Model
{
    ...
    public partial class Field : IEquatable<Field>, IValidatableObject
    {
        ...
        public Field(int type = default(int), string placeholder = default(string), Validations validations = default(Validations), string hint = default(string), string icon = default(string), string label = default(string), Options options = default(Options))
        {
            this.Type = type;
