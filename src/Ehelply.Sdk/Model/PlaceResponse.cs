...
namespace Ehelply.Sdk.Model
{
    ...
    public partial class PlaceResponse : IEquatable<PlaceResponse>, IValidatableObject
    {
        ...
        public PlaceResponse(string projectUuid = default(string), string name = default(string), string summary = default(string), bool _public = true, Object meta = default(Object), List<AddressBase> addresses = default(List<AddressBase>), ContactBase contact = default(ContactBase), string picture = default(string), string uuid = default(string), string metaUuid = default(string), List<TagBase> tags = default(List<TagBase>), List<CategoryBase> categories = default(List<CategoryBase>), Company company = default(Company), string createdAt = default(string), string updatedAt = default(string), string deletedAt = default(string))
        {
