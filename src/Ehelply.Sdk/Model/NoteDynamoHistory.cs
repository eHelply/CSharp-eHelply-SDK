...
namespace Ehelply.Sdk.Model
{
    ...
    public partial class NoteDynamoHistory : IEquatable<NoteDynamoHistory>, IValidatableObject
    {
        ...
        public NoteDynamoHistory(string uuid = default(string), System.IO.Stream content = default(System.IO.Stream), string time = default(string), NoteMeta meta = default(NoteMeta), List<NoteDynamoResponse> history = default(List<NoteDynamoResponse>))
        {
