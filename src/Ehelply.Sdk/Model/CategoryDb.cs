...
namespace Ehelply.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CategoryDb")]
    public partial class CategoryDb : IEquatable<CategoryDb>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CategoryDb" /> class.
        /// </summary>
        ...
        public CategoryDb(string uuid = default(string), string name = default(string), string projectUuid = default(string), string metaUuid = default(string))
        {
            // to ensure "uuid" is required (not null)
            if (uuid == null)
            {
                throw new ArgumentNullException("uuid is a required property for CategoryDb and cannot be null");
            }
            this.Uuid = uuid;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CategoryDb and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as CategoryDb);
        }

        /// <summary>
        /// Returns true if CategoryDb instances are equal
        /// </summary>
        /// <param name="input">Instance of CategoryDb to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CategoryDb input)
        {
            if (input == null)
            {
                return false;
