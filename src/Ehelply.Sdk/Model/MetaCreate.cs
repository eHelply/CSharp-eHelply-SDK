...
namespace Ehelply.Sdk.Model
{
    ...
    public partial class MetaCreate : IEquatable<MetaCreate>, IValidatableObject
    {
        ...
        public MetaCreate(BasicMetaCreate basic = default(BasicMetaCreate), DetailedMetaCreate detailed = default(DetailedMetaCreate), Dictionary<string, string> custom = default(Dictionary<string, string>), List<Field> fields = default(List<Field>), List<Dictionary<string, string>> children = default(List<Dictionary<string, string>>), string parentUuid = default(string))
        {
            this.Basic = basic;
