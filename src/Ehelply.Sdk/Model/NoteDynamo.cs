...
namespace Ehelply.Sdk.Model
{
    ...
    public partial class NoteDynamo : IEquatable<NoteDynamo>, IValidatableObject
    {
        ...
        public NoteDynamo(string uuid = default(string), AnyOffilestring content = default(AnyOffilestring), string time = default(string), NoteMeta meta = default(NoteMeta))
        {
