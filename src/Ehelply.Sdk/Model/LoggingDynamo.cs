...
namespace Ehelply.Sdk.Model
{
    ...
    public partial class LoggingDynamo : IEquatable<LoggingDynamo>, IValidatableObject
    {
        ...
        public LoggingDynamo(string service = default(string), string time = default(string), Object log = default(Object), string severity = default(string), string subject = default(string))
        {
