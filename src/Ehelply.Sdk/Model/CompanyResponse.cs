...
namespace Ehelply.Sdk.Model
{
    ...
    public partial class CompanyResponse : IEquatable<CompanyResponse>, IValidatableObject
    {
        ...
        public CompanyResponse(string name = default(string), string summary = default(string), bool _public = true, Object meta = default(Object), ContactBase contact = default(ContactBase), string uuid = default(string), string projectUuid = default(string), string metaUuid = default(string), Object catalogData = default(Object), Object reviewGroupData = default(Object), Object scheduleData = default(Object), Object blogData = default(Object), List<TagBase> tags = default(List<TagBase>), List<CategoryBase> categories = default(List<CategoryBase>), List<PlaceBase> places = default(List<PlaceBase>), string createdAt = default(string), string updatedAt = default(string), string deletedAt = default(string))
        {
