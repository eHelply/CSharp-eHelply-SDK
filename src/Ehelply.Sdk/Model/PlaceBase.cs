...
namespace Ehelply.Sdk.Model
{
    ...
    public partial class PlaceBase : IEquatable<PlaceBase>, IValidatableObject
    {
        ...
        public PlaceBase(string projectUuid = default(string), string name = default(string), string summary = default(string), bool _public = true, Object meta = default(Object), List<AddressBase> addresses = default(List<AddressBase>), ContactBase contact = default(ContactBase), string picture = default(string))
        {
