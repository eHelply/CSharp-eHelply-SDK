...
namespace Ehelply.Sdk.Model
{
    ...
    public partial class TagResponse : IEquatable<TagResponse>, IValidatableObject
    {
        ...
        public TagResponse(string uuid = default(string), string name = default(string), string projectUuid = default(string))
        {
            // to ensure "uuid" is required (not null)
            if (uuid == null)
            {
                throw new ArgumentNullException("uuid is a required property for TagResponse and cannot be null");
            }
            this.Uuid = uuid;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TagResponse and cannot be null");
            }
            this.Name = name;
