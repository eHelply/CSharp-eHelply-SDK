...
namespace Ehelply.Sdk.Model
{
    ...
    /// Detailed
    /// </summary>
    [DataContract(Name = "Detailed")]
    public partial class Detailed : IEquatable<Detailed>, IValidatableObject
    {
        /// <summary>
        ...
        public Detailed(string summaryUuid = default(string), string descriptionUuid = default(string))
        {
        ...
        {
            return this.Equals(input as Detailed);
        }

        /// <summary>
        /// Returns true if Detailed instances are equal
        /// </summary>
        /// <param name="input">Instance of Detailed to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Detailed input)
        {
            if (input == null)
            {
                return false;
