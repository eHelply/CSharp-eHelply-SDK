...
namespace Ehelply.Sdk.Model
{
    ...
    /// StaffBase
    /// </summary>
    [DataContract(Name = "StaffBase")]
    public partial class StaffBase : IEquatable<StaffBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StaffBase" /> class.
        /// </summary>
        ...
        public StaffBase(string entityUuid = default(string), string projectUuid = default(string), string scheduleUuid = default(string), string catalogUuid = default(string), string reviewGroupUuid = default(string))
        {
            // to ensure "entityUuid" is required (not null)
            if (entityUuid == null)
            {
                throw new ArgumentNullException("entityUuid is a required property for StaffBase and cannot be null");
            }
        ...
        {
            return this.Equals(input as StaffBase);
        }

        /// <summary>
        /// Returns true if StaffBase instances are equal
        /// </summary>
        /// <param name="input">Instance of StaffBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StaffBase input)
        {
            if (input == null)
            {
                return false;
