...
namespace Ehelply.Sdk.Model
{
    ...
    public partial class MetaDynamo : IEquatable<MetaDynamo>, IValidatableObject
    {
        ...
        public MetaDynamo(Basic basic = default(Basic), Detailed detailed = default(Detailed), Object custom = default(Object), Dates dates = default(Dates), List<Field> fields = default(List<Field>), List<Object> children = default(List<Object>), string parentUuid = default(string), string uuid = default(string))
        {
