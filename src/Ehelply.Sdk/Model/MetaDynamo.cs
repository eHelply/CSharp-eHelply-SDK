...
namespace Ehelply.Sdk.Model
{
    ...
    public partial class MetaDynamo : IEquatable<MetaDynamo>, IValidatableObject
    {
        ...
        public MetaDynamo(BasicMeta basic = default(BasicMeta), DetailedMeta detailed = default(DetailedMeta), Object custom = default(Object), DatesMeta dates = default(DatesMeta), List<Field> fields = default(List<Field>), List<Object> children = default(List<Object>), string parentUuid = default(string), string uuid = default(string))
        {
