# Ehelply.Sdk - the C# library for the eHelply SDK - 1.1.72
...
## Documentation for Models
 ...
 - [Model.PlacesHTTPValidationError](docs/PlacesHTTPValidationError.md)
 - [Model.PlacesValidationError](docs/PlacesValidationError.md)
