...
*DefaultApi* | [**AppointmentssearchAppointmentEntities**](docs/DefaultApi.md#appointmentssearchappointmententities) | **GET** /appointments/appointments/entities/{entity_uuid}/appointments | Get Entities Appointments
