...
<a name="createnote"></a>
# **CreateNote**
> NoteDynamo CreateNote (NoteBase noteBase, string xAccessToken = null, string xSecretToken = null, string authorization = null, string ehelplyActiveParticipant = null, string ehelplyProject = null, string ehelplyData = null)
...
namespace Example
{
    public class CreateNoteExample
    {
        public static void Main()
        {
            ...
            var noteBase = new NoteBase(); // NoteBase | 
...
namespace Example
{
    public class DeleteNoteExample
    {
        public static void Main()
        {
            ...
            var method = method_example;  // string |  (optional)  (default to "previous")
            var xAccessToken = xAccessToken_example;  // string |  (optional) 
            var xSecretToken = xSecretToken_example;  // string |  (optional) 
            var authorization = authorization_example;  // string |  (optional) 
            var ehelplyActiveParticipant = ehelplyActiveParticipant_example;  // string |  (optional) 
...
namespace Example
{
    public class GetNoteExample
    {
        public static void Main()
        {
            ...
            var historyContent = true;  // bool? |  (optional)  (default to true)
            var xAccessToken = xAccessToken_example;  // string |  (optional) 
            var xSecretToken = xSecretToken_example;  // string |  (optional) 
            var authorization = authorization_example;  // string |  (optional) 
            var ehelplyActiveParticipant = ehelplyActiveParticipant_example;  // string |  (optional) 
...
<a name="updatenote"></a>
# **UpdateNote**
> NoteDynamo UpdateNote (string noteId, NoteBase noteBase, string xAccessToken = null, string xSecretToken = null, string authorization = null, string ehelplyActiveParticipant = null, string ehelplyProject = null, string ehelplyData = null)
